...
export abstract class StateService {
  ...
  abstract updateTable(
    id: string,
    updates: Partial<import('./tables').Table>
  ): void;
  ...
  abstract addColumn(
    tableId: string,
    column: Omit<import('./tables').Column, 'id'>
  ): string;
  abstract updateColumn(
    tableId: string,
    columnId: string,
    updates: Partial<import('./tables').Column>
  ): void;
  abstract deleteColumn(tableId: string, columnId: string): void;

  // Relationship operations
  abstract addRelationship(
    relationship: Omit<import('./relationships').Relationship, 'id'>
  ): string;
  abstract updateRelationship(
    id: string,
    updates: Partial<import('./relationships').Relationship>
  ): void;
  ...
  abstract updateNote(
    id: string,
    updates: Partial<import('./notes').Note>
  ): void;
