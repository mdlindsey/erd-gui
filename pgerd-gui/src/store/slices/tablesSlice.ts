...
import { TablesState, Table, Column, Position, CreateTablePayload, CreateColumnPayload } from '../../types';
...
const tablesSlice = createSlice({
  ...
  reducers: {
    ...
    updateTable: (state, action: PayloadAction<{ id: string; updates: Partial<Omit<Table, 'id' | 'columns'>> }>) => {
    ...
    // Table positioning
    moveTable: (state, action: PayloadAction<{ id: string; position: Position }>) => {
    ...
    moveMultipleTables: (state, action: PayloadAction<{ updates: Array<{ id: string; position: Position }> }>) => {
    ...
    reorderColumns: (state, action: PayloadAction<{ 
      tableId: string; 
      startIndex: number; 
      endIndex: number 
    }>) => {
    ...
    // Bulk operations
    duplicateTable: (state, action: PayloadAction<{ 
      id: string; 
      position: Position; 
      nameSuffix?: string 
    }>) => {
