...
const schemaBoxesSlice = createSlice({
  ...
  reducers: {
    ...
    updateSchemaBox: (state, action: PayloadAction<{ 
      id: string; 
    ...
    moveSchemaBox: (state, action: PayloadAction<{ 
      id: string; 
    ...
    resizeSchemaBox: (state, action: PayloadAction<{ 
      id: string; 
    ...
    addTableToSchemaBox: (state, action: PayloadAction<{ 
      schemaBoxId: string; 
      tableId: string 
    }>) => {
    ...
    removeTableFromSchemaBox: (state, action: PayloadAction<{ 
      schemaBoxId: string; 
      tableId: string 
    }>) => {
      const { schemaBoxId, tableId } = action.payload;
